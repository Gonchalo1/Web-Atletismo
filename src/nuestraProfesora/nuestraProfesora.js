      ...
      <div id="carouselExampleCaptions" className="carousel slide">
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src={Carousel1} className="d-block w-100 mx-auto" alt="Primer Slide"/>
          ...
          <div className="carousel-item">
            <img src={Carousel2} className="d-block w-100 mx-auto" alt="Segundo Slide"/>
            <div className="carousel-caption d-none d-md-block">
          ...
          <div className="carousel-item">
            <img src={Carousel3} className="d-block w-100 mx-auto" alt="Tercer Slide"/>
            <div className="carousel-caption d-none d-md-block">
              <h5>Tercer Título</h5>
